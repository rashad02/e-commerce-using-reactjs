...
class CheckOutSummary extends React.Component{
    ...
    render() {
        ...
        let {total, discountTotal} = this.props;
        ...
        return (
            <div>
                <div className="checkout-summary">
                    ...
                    <div className="input-section">
                        ...
                        <InputGroup >
                            ...
                            />
                            <InputGroup.Append >
                                <Button className="apply-button" variant="outline-secondary" onClick={this.handleSubmit}>Apply</Button>
                            </InputGroup.Append>
                        </InputGroup>
                    </div>
                ...
                <StripeCheckoutButton price={total-discountTotal} couponCode={this.state.couponCode || ""}/>
            </div>
        )
    }
}
