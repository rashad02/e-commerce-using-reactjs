...
promoRouter.post('/', (request, response) => {
    let responseData = {
      success: false,
      data: {},
      errors: []
    ...
    if (request.body.promoCode) {
        ...
        Promo.findOne({promoCode: request.body.promoCode}, (error, document) => {
            if (!document) {
                let promo = {
...
promoRouter.get('/', (request, response) => {
    let responseData = {
      success: false,
      data: {},
      errors: []
  ...
  promoRouter.put('/', (request, response) => {
    let responseData = {
      success: false,
      data: {},
      errors: []
